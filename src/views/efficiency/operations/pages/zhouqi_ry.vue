...
<script setup lang="ts">
  ...
  interface ZhouqiRyData {
    ...
    zhouqiZt: number | null
    zhouqiWyn: number | null
    zhouqiWys: number | null
    chakanZt: number | null
    cuidingZt: number | null
    dingsunZt: number | null
    zhifuZt: number | null
  ...
  const fetchAllForDropdown = async () => {
    ...
    try {
      const res = await dataReport.axiosRequestZhouqiRy({
        current: 1,
        size: 9999,
